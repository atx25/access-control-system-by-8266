 ...
 * @LastEditTime: 2023-05-31 20:46:09
...
upDate(String name)
{
  UPDATE `drom`.`t_record` SET `studentNumber` = '009' , `studentName` = '安天祥' , `dormBuildId` = '5' , `dormName` = '233' , `date` = '2023-05-31' WHERE `recordId` = '10'; 
}
bool Receivebyte()
{
    int i,dn;
