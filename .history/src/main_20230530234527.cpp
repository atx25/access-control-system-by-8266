 ...
 * @LastEditTime: 2023-05-30 23:45:15
...
{ 
  if(Receivebyte()==true)
  {
    sprintf(str,"%d%d%d%d%d%d%d%d%d%d",Rxbyte[1],Rxbyte[2],Rxbyte[3],Rxbyte[4],Rxbyte[5],
                                      Rxbyte[6],Rxbyte[7],Rxbyte[8],Rxbyte[9],Rxbyte[10]);
    Serial.println(str);
