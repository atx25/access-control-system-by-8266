 ...
 * @LastEditTime: 2023-05-30 23:16:26
...
{ 
  if(Receivebyte()==1)
  {
    ...
    {
      sprintf(str[0],"%d%d%d",Rxbyte[0],Rxbyte[1],Rxbyte[2]);
      sprintf(str[1],"%d%d%d",Rxbyte[0],Rxbyte[1],Rxbyte[2]);
      sprintf(str[2],"%d%d%d",Rxbyte[0],Rxbyte[1],Rxbyte[2]);
      insert into t_record values(null,str[0],str[1],str[2],str[3],
      str[4],str[5])
    }
  }
}
