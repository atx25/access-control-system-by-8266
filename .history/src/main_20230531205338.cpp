 ...
 * @LastEditTime: 2023-05-31 20:53:16
...
struct key ks[3]={{50,48,50,68,65,54,50,48},0,{66,48,48,53,49,69,68,65},0,{56,54,49,66,50,49,69,65},0}
...
upDate(int i)
{
  ...
  switch (i)
  {
    case 0:
    //添加安天祥的信息;
    sprintf(query, "UPDATE 'drom'.'t_record' SET 'studentNumber' = '001' , 'studentName' = '安天祥' , 'dormBuildId' = '5' ,
            'dormName' = '233' , 'date' = '2023-05-31' WHERE 'recordId' = '1'; "); 
      break;
    case 1:
    //添加余威望的信息;
    sprintf(query, "UPDATE 'drom'.'t_record' SET 'studentNumber' = '002' , 'studentName' = '余威望' , 'dormBuildId' = '5' ,
            'dormName' = '233' , 'date' = '2023-05-31' WHERE 'recordId' = '2'; "); 
      break;
    case 2:
        //添加王正正的信息;
    sprintf(query, "UPDATE 'drom'.'t_record' SET 'studentNumber' = '003' , 'studentName' = '安天祥' , 'dormBuildId' = '5' ,
            'dormName' = '233' , 'date' = '2023-05-31' WHERE 'recordId' = '10'; "); 
    break;
    default:
    break;
  }
