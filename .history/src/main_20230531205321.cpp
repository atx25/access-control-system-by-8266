...
upDate(int i)
{
  ...
  switch (i)
  {
    ...
    case 1:
    //添加余威望的信息;
    sprintf(query, "UPDATE 'drom'.'t_record' SET 'studentNumber' = '009' , 'studentName' = '余威望' , 'dormBuildId' = '5' ,
            'dormName' = '233' , 'date' = '2023-05-31' WHERE 'recordId' = '10'; "); 
      break;
    case 2:
        //添加王正正的信息;
    sprintf(query, "UPDATE 'drom'.'t_record' SET 'studentNumber' = '009' , 'studentName' = '安天祥' , 'dormBuildId' = '5' ,
            'dormName' = '233' , 'date' = '2023-05-31' WHERE 'recordId' = '10'; "); 
    break;
    default:
    break;
