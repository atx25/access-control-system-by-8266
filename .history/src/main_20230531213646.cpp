 ...
 * @LastEditTime: 2023-05-31 21:36:26
...
void upDate(int i)
{
  ...
  switch (i)
  {
    ...
    case 2:
        //添加王正正的信息;
    sprintf(query, "insert into `drom`.`t_record` (`studentNumber`,`studentName`,`dormBuildId`,`dormName`,`date`,`detail`) values ('003','安天祥','9','233','2023-05-31','晚归');"); 
    break;
  }
    if (conn.connected()) { 
    MySQL_Cursor *cur_mem = new MySQL_Cursor(&conn); 
