 ...
 * @LastEditTime: 2023-05-30 23:42:35
...
struct students s[3]={"861B21EA","001","202DA620","002","631680A9","003"};
int Rxbyte[13];
char query[200]; 
char * str;
bool Receivebyte()
...
{ 
  if(Receivebyte()==true)
  {
    sprintf(str,"%d%d%d%d%d%d%d%d%d%d",Rxbyte[1],Rxbyte[2],Rxbyte[3],Rxbyte[4],Rxbyte[5],Rxbyte[6],Rxbyte[7],Rxbyte[8],Rxbyte[9],Rxbyte[10],)
    Serial.println(str);
    if(Rxbyte[0]==0x02&&Rxbyte[11]==0x03)
    {
